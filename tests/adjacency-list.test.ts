import t from 'tap';
import { createGraph, hasValue, addDirectedValue, addUndirectedValue, addNode, getAllValues, hasDirectedValue, hasUndirectedValue } from '../src/graphs/adjacency-list.js';
