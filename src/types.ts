...
export interface IDocumentsStore<S extends Schema, I extends OpaqueIndex, D extends OpaqueDocumentStore> {
  ...
  getMultiple: (store: D, ids: string[]) => SyncOrAsyncValue<Array<Document | undefined>>;
...
export interface ArrayCallbackComponents<S extends Schema, I extends OpaqueIndex, D extends OpaqueDocumentStore> {
  beforeInsert: Array<SingleCallbackComponent<S, I, D>>;
  afterInsert: Array<SingleCallbackComponent<S, I, D>>;
  beforeRemove: Array<SingleCallbackComponent<S, I, D>>;
  afterRemove: Array<SingleCallbackComponent<S, I, D>>;
  beforeUpdate: Array<SingleCallbackComponent<S, I, D>>;
  afterUpdate: Array<SingleCallbackComponent<S, I, D>>;
  beforeMultipleInsert: Array<MultipleCallbackComponent<S, I, D>>;
  afterMultipleInsert: Array<MultipleCallbackComponent<S, I, D>>;
  beforeMultipleRemove: Array<MultipleCallbackComponent<S, I, D>>;
  afterMultipleRemove: Array<MultipleCallbackComponent<S, I, D>>;
  beforeMultipleUpdate: Array<MultipleCallbackComponent<S, I, D>>;
  afterMultipleUpdate: Array<MultipleCallbackComponent<S, I, D>>;
}
