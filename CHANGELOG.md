...
#### [0.1.1](https://github.com/nearform/lyra/compare/0.1.0...0.1.1)

- chore: changed org references to @lyrasearch in repo [`f82fb9c`](https://github.com/nearform/lyra/commit/f82fb9c4977822714c5cfd07d6c82901bfb32d73)
- chore(lyra): prepares for v0.1.1 [`2ce6404`](https://github.com/nearform/lyra/commit/2ce6404ff28eb27fef2d418ab2d7899ff14d81d8)

#### [0.1.0](https://github.com/nearform/lyra/compare/0.0.5...0.1.0)

> 23 August 2022

- fix(lyra): throws an error when trying to override the "id" schema property [`#100`](https://github.com/nearform/lyra/issues/100)
- docs(changelog): updates changelog [`9a43b20`](https://github.com/nearform/lyra/commit/9a43b200e2e91487c5c0991f7284ae9b7e990e29)
- chore(benchmarks): update benchmark table [`ed3bd48`](https://github.com/nearform/lyra/commit/ed3bd48c904f8229b65af22007fa9e2fdfcf3021)
- chore(benchmarks): update benchmark table [`28a5a22`](https://github.com/nearform/lyra/commit/28a5a2297791b95151e05db5c1419ace9fc98854)

#### [0.0.5](https://github.com/nearform/lyra/compare/0.0.4...0.0.5)

> 21 August 2022

- refactor: improve types in repl.ts [`#96`](https://github.com/nearform/lyra/pull/96)
- refactor: fix some minor linter warnings [`#95`](https://github.com/nearform/lyra/pull/95)
- docs: add inline documentation [`#91`](https://github.com/nearform/lyra/pull/91)
- docs: fix typo in example import statements [`#92`](https://github.com/nearform/lyra/pull/92)
- Demo page improvements and restyling [`#81`](https://github.com/nearform/lyra/pull/81)
- fix(lyra): removes access to process and performance global variable if not supported in the runtime [`#98`](https://github.com/nearform/lyra/issues/98)
- refactor(docs): removes docs from monorepo [`b28c6cb`](https://github.com/nearform/lyra/commit/b28c6cb46633f319603fdc14524820d24ba31415)
- refactor(docs): removes docs workflow [`c358373`](https://github.com/nearform/lyra/commit/c35837319b0f429a8b69cccb76493b52ddc8ce45)
- docs: updates changelog [`81a78c0`](https://github.com/nearform/lyra/commit/81a78c05bdf3ecd6846a2de1f91bee28afb8ea75)

#### [0.0.4](https://github.com/nearform/lyra/compare/0.0.3...0.0.4)

> 9 August 2022

- chore: update benchmarks to run only on main [`#90`](https://github.com/nearform/lyra/pull/90)
- chore: add benchmark-comparisson workflow [`#89`](https://github.com/nearform/lyra/pull/89)
- fix: intelliSense not working for some params of insert/search [`#86`](https://github.com/nearform/lyra/pull/86)
- feat(benchmarks): adds comparision with other libraries [`c52189f`](https://github.com/nearform/lyra/commit/c52189f2ab5eb2d71e5bc41de80e74e2591331b6)
- feat(lyra): adds possibility to save and load Lyra schema [`290c8a2`](https://github.com/nearform/lyra/commit/290c8a29db0e2433271ef0599212c24a9ca3779a)
- refactor(edge): removes edge package [`50e44ad`](https://github.com/nearform/lyra/commit/50e44ad38b1f822aad6f0c57fd238501b2bf7ff3)

#### [0.0.3](https://github.com/nearform/lyra/compare/0.0.2...0.0.3)

> 5 August 2022

- docs: fix favicon and README logo links [`#84`](https://github.com/nearform/lyra/pull/84)
- feat: Remove fastq. [`#83`](https://github.com/nearform/lyra/pull/83)
- No fast properties and demo redesign [`#82`](https://github.com/nearform/lyra/pull/82)
- docs: updates changelog [`725e6dd`](https://github.com/nearform/lyra/commit/725e6ddce5980765d2179e44c4b2a7397dc81778)
- chore(benchmarks): update benchmark table [`19b9283`](https://github.com/nearform/lyra/commit/19b9283a6e65de85bed360facb294817e7ec9e0a)
- chore(benchmarks): update benchmark table [`d56aaf0`](https://github.com/nearform/lyra/commit/d56aaf0918db663d12f01bfa81b3dccb3fc46598)
