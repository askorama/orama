...
export default function SearchBar(): JSX.Element {
  ...
  useEffect(() => {
    ...
    const search = autocomplete({
      ...
      render({ sections }, root) {
        const populatedRoot = createRoot(root)
        populatedRoot.render(<SearchResults sections={sections} />)
      },
      renderNoResults({ state }, root) {
        const populatedRoot = createRoot(root)
        populatedRoot.render(<SearchNoResults query={state.query} />)
      }
    })
  ...
  return (
    <div ref={containerRef} className={styles.oramaSearchBar}>
