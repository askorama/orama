...
const LyraLogo = (): JSX.Element => {
    return (
        <div className={styles.logo}>
            <svg viewBox="0 0 1500 566" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="464.503" y1="96.3779" x2="354.282" y2="193.632" stroke="url(#paint1_linear_4_28)" stroke-width="15"/>
                ...
                <path d="M131.5 468.5C131.5 483.865 118.839 496.5 103 496.5C87.1606 496.5 74.5 483.865 74.5 468.5C74.5 453.135 87.1606 440.5 103 440.5C118.839 440.5 131.5 453.135 131.5 468.5Z" stroke="white" stroke-width="15"/>
                <circle cx="289.5" cy="472.5" r="28" stroke="white" stroke-width="15"/>
                <circle cx="143.139" cy="224.205" r="23.0656" stroke="white" stroke-width="15"/>
                <circle cx="336.721" cy="207.533" r="23.0656" stroke="white" stroke-width="15"/>
                ...
                <rect x="499.308" y="326.006" width="12.3005" height="12.3005" transform="rotate(-45 499.308 326.006)" fill="white"/>
                <rect x="50" y="207.698" width="12.3005" height="12.3005" transform="rotate(-45 50 207.698)" fill="white"/>
