...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab>```bash copy npm install @orama/plugin-docusaurus ```</Tab>
  <Tab>```bash copy yarn add @orama/plugin-docusaurus ```</Tab>
  <Tab>```bash copy pnpm add @orama/plugin-docusaurus ```</Tab>
</Tabs>
