...
description: Learn how to create a new Orama instance with a schema.
---
...
If you want to learn more and see real-world examples, check out [this blog post](https://askorama.com/blog/optimizing-orama-schema-optimization) we wrote about schema optimization.
