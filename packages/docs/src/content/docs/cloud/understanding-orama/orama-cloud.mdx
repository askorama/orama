...
Orama started out as a super-fast, dependency free [open source search engine library](/open-source), and eventually evolved in a much more ambitious project: delivering a complete new search experience, leveraging AI search and precise AI-generated answers.

**Orama Cloud** brings **Orama** to the next level. 

In just a few minutes, you can deploy [a new index](/cloud/understanding-orama/indexes) to **300** global locations in **100** countries all over the world. This allows Orama to be extremely fast, resilient, and scalable. 

It also provides a wide range of features that are hard to find all-in-one in other solutions.

Orama Cloud features include:
...
Orama Cloud is a unique answer engine that provides a wide range of features that are hard to find all-in-one in other solutions.
