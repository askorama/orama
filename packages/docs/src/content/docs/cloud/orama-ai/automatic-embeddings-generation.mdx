...
To perform vector and hybrid searches on your data using the **Orama AI** (Orama Native Embeddings), no configuration is necessary.
...
You can download the same JSON file here: [download example dataset](/cloud/guides/example-datasets/games.json).
