...
To do that, go to your [dashboard](https://cloud.orama.com/indexes) and click on "Import data from e-commerce":
...
Click on the Shopify logo to create a new Shopify index:
...
Give your index a name and click on "Create index":
...
You will also need to select the embedding model used to perform vector and hybrid search. By default, **Orama GTE-small** is selected, and we recommend using it for most use cases, as it's free, faster, and more optimized than OpenAI's models.
