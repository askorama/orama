...
const errors = {
  ...
  BUNDLED_ORAMA:
    'Cannot find the stemmer for the locale "%s". This can happen if you are using Orama within a bundler like webpack. To solve this issue please look at https://docs.oramasearch.com/text-analysis/stemming#using-stemming-with-bundlers.',
