import type { AnyOrama, Results, SearchParamsVector, TypedDocument, Result } from '../types.ts'
import type { InternalDocumentID } from '../components/internal-document-id-store.ts'
import { createSearchContext } from './search.ts'
import { getNanosecondsTime, formatNanoseconds } from '../utils.ts'
...
import { getInternalDocumentId, getDocumentIdFromInternalId } from '../components/internal-document-id-store.ts'
