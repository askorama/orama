...
function stem () {
  ...
  function h () {
    ...
    switch (a) {
      case 1:
        if (!(m.j.length > 3) || !m.b('\u0623')) return p
        break
      case 2:
        if (!(m.j.length > 3) || !m.b('\u0622')) return p
        break
      case 3:
        if (!(m.j.length > 3) || !m.b('\u0627')) return p
        break
      case 4:
        if (!(m.j.length > 3) || !m.b('\u0625')) return p
    }
    return g
  }
  function c () {
  ...
  function a () {
    ...
    switch (a) {
      case 1:
        if (!(m.j.length > 5) || !m.e()) return p
        break
      case 2:
        if (!(m.j.length > 4) || !m.e()) return p
    }
    return g
  }
  function d () {
    ...
    switch (a) {
      case 1:
        if (!(m.j.length > 3) || !m.e()) return p
        break
      case 2:
        if (!(m.j.length > 3) || !m.b('\u0628')) return p
        break
      case 3:
        if (!(m.j.length > 3) || !m.b('\u0643')) return p
    }
    return g
  }
  function n () {
    ...
    switch (a) {
      case 1:
        if (!(m.j.length > 4) || !m.b('\u064a')) return p
        break
      case 2:
        if (!(m.j.length > 4) || !m.b('\u062a')) return p
        break
      case 3:
        if (!(m.j.length > 4) || !m.b('\u0646')) return p
        break
      case 4:
        if (!(m.j.length > 4) || !m.b('\u0623')) return p
    }
    return g
  }
  function v () {
  ...
  function b () {
    ...
    if (m.h(M) == 0) return p
    m.c = m.cursor
    return !(m.j.length > 4) || !m.e() ? p : g
  }
  function f () {
    m.d = m.cursor
    if (m.h(P) == 0) return p
    m.c = m.cursor
    return !(m.j.length >= 5) || !m.e() ? p : g
  }
  function q () {
    m.d = m.cursor
    if (m.h(Q) == 0) return p
  ...
  this.l = function () {
    ...
    if (u != 0) {
      switch (((m.d = m.cursor), u)) {
        case 1:
          if (!(m.j.length > 4)) break
          K = g
          J = p
          L = g
          break
        case 2:
          if (!(m.j.length > 3)) break
          K = g
          J = p
          L = g
      }
    ...
    b: {
      ...
      c: if (J) {
        d: {
          ...
          m.cursor = m.a - w
          m.d = m.cursor
          m.h(V) == 0 ? (y = p) : ((m.c = m.cursor), (y = !(m.j.length >= 5) || !m.e() ? p : g))
          if (y) break d
          m.cursor = m.a - w
          if (!s()) break c
        }
      ...
      if (K) {
        ...
        e: {
          y = m.a - m.cursor
          m.d = m.cursor
          m.h(T) == 0 ? (A = p) : ((m.c = m.cursor), (A = !(m.j.length >= 4) || !m.e() ? p : g))
          if (A) break e
          m.cursor = m.a - y
          f: {
            if (L) break f
          ...
          m.cursor = m.a - y
          f: if (
            ((m.d = m.cursor), m.h(N) == 0 ? (A = p) : ((m.c = m.cursor), (A = !(m.j.length > 5) || !m.e() ? p : g)), A)
          ) {
            g: {
              A = m.a - m.cursor
              if (b()) break g
        ...
        m.d = m.cursor
        m.h(U) == 0 ? (w = p) : ((m.c = m.cursor), (w = !(m.j.length >= 3) || !m.e() ? p : g))
        if (w) break b
      }
      m.cursor = m.a - u
      m.d = m.cursor
      m.h(D) != 0 && ((m.c = m.cursor), m.b('\u064a'))
    }
    m.cursor = m.a - e
    m.cursor = m.f
    e = m.cursor
    ...
    b: {
      ...
      J &&
        ...
        n() || (m.cursor = u),
        (m.c = m.cursor),
        m.o(x) != 0 && ((m.d = m.cursor), m.j.length > 4 && ((J = g), (K = p), m.b('\u0627\u0633\u062a'))))
    }
    m.cursor = e
    l()
    return g
